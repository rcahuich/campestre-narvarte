...
<html>
            ...
            $(document).on('click', '#savePerson', function (e) {
                ...
                if($("#form").valid()){
                    ...
                    $.ajax({
                        type: "POST",
                        data: $('#form').serialize(),
                        url: '<g:createLink controller="person" action="updatePerson"/>',
	...
	<body>
        <div class="container">
            <h3 class="header light">Actualizar datos de "${person.name}"</h3>
            ...
            <div id="formData" class="row">
                <form id="form" class="col s12">
                    ...
                    <div class="card-panel">
                        <a class="waves-effect waves-light btn" href="${createLink(action: "detail", id: person.id)}">Cancelar</a>
                        <a class="waves-effect waves-light btn" href="#" id="savePerson"> Actualizar registro</a>
                    </div>
                </form>
            </div>
